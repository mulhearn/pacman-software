...
void set_atc_default_config(){
  ...
  //POKE A destination configuration:  This is a SYNC pulse, H+T, duration 5
  axil_write_register(C_SCOPE_ATC + C_ADDR_ATC_DST_POKE_A, 0x0032FFC6);

  //POKE B destination configuration:  This is a SYNC pulse, H+T, duration 5
  axil_write_register(C_SCOPE_ATC + C_ADDR_ATC_DST_POKE_B, 0x0032FFC6);

  //POKE C destination configuration:  This is an INTERNAL_RESET pulse, G, duration 24
  axil_write_register(C_SCOPE_ATC + C_ADDR_ATC_DST_POKE_C, 0x00F0FFC1);

  //POKE D destination configuration:  This is a FULL_RESET pulse, G, duration 1024
  axil_write_register(C_SCOPE_ATC + C_ADDR_ATC_DST_POKE_D, 0x2800FFC1);
